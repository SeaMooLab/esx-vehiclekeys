...
-- Lockpick Settings
-- 'auto' registers ESX usable item callbacks and guards inventory bridge errors with pcall.
-- Use false/'disabled'/'none' to disable automatic registration if your inventory wires items directly.
